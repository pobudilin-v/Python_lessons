...
# n1 = 10
# n2 = 20
# если много значений, так не делать как ниже!
...
# # # #
# print(1 == 1 and 3 == 3 or 1 == 1)  # поверне True якщо обидва операнди рівні True, інакше False &&
# print(1 == 1 or 2 == 3 or 1 == 3)  # поверне True якщо хоча б один операнд дорівнює True, інакше False ||
# # # #
# is_valid = False
# print(is_valid)
...
# v2 elif можно писать сколько угодно!
# if 12 <= hours < 24:  # hours >= 12 and hours < 24 (можно так еще писать)
#     print("PM")
# elif 0 <= hours < 12:
#     print("AM")
# else:
...
# Вкладенных умов не больше 4-5 (можно и больше но уже не красиво)
...
# самы рабочий вариант, но баг если вписать все одинаковые
...
#     print(number3)
# Все одинаковые фиксится: первые три строки ниже

# v2 додатковый прыклат на вкладані умови1
...
#
# # # v2 В домашке калькулятор делать через match.
# match user_select:
#     case 1:
#         print("Starting game...")
#     case 2:
...
#     case 4:
#         print("Exit")
#     case _: # аналог else, принято писать нижнее подчеркивание
#         print("Invalid input please try again")

# нельзя зминну называть нижним подчеркивание, хотя оно будет работать
# _ = "test user"
# print(_)
...
######### тут лучше не делать тернарный оператор как в конце!
# number_b = 30
#
# if number_b < 5:
#     if number_b % 2 == 0:
...
# тут индексы 0 1 2 3 4 5
# # #
# # print(numbers)
# # #
# # # # # [] -> індексатори
# # # # # Індекс - це порядковий номер елемента в колекції (масиві). Note: не всі колекції підтримують індекси.
# # # # # Індекси рахуються з нуля, индекс смещение относительно первого элемента
# print(numbers[0])
# print (numbers[3])
#
# numbers[1] = 11111 #это меняет по индексу значение в списке
# print(numbers)
...
# print(numbers[:])
# print(numbers[1:])
# print(numbers[1:5]) # 1 <= index < 5 (без пятого индекса)
# print(numbers[:5])
# print(numbers[1:5:2]) # так же как и 3 принт, только каждый второй
